...
[![Portfolio Preview](https://raw.githubusercontent.com/Sonu0070/mohammed-sohail-portfolio/main/docs/preview-home.png)](https://mohammed-sohail-portfolio.netlify.app)
...
- Growing hands-on exposure with Python, Kali Linux, Wireshark, Metasploit Framework, and GitHub
...
- `SecurAI` - AI-powered threat analyzer
- `AI Phishing Detector` - suspicious message and URL analysis. [Live Demo](https://sonu0070.github.io/ai-phishing-detector/) | [GitHub](https://github.com/Sonu0070/ai-phishing-detector)
- `Log Analysis Agent` - converts raw logs into incident clues
- `SOC Copilot Lite` - alert summarization assistant
- `Prompt Injection Sandbox` - testing LLM security risks
- `Threat Surface Visualizer` - maps systems and attack exposure

## Goal

To grow into an AI Security Analyst and future Security Engineer who can build secure, intelligent systems that solve real-world problems.
...
- Portfolio: [mohammed-sohail-portfolio.netlify.app](https://mohammed-sohail-portfolio.netlify.app)
- AI Phishing Detector: [Live Demo](https://sonu0070.github.io/ai-phishing-detector/) | [Repository](https://github.com/Sonu0070/ai-phishing-detector)
